          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="animate-slide-in-right space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-slate-600">Customer Support: +1 6077380470</p>
                      <p className="text-slate-600">Loan Department: +1 6077380470</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="flex-shrink-0">
              ...
              <div className="bg-orange-50 p-6 rounded-lg">
                ...
                <div className="text-2xl font-bold text-orange-600">+1 6077380470</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-lg animate-fade-in-up">
              ...
              <div className="space-y-3 text-slate-600">
                ...
                <div className="flex items-center">
                  ...
                  <span className="text-sm">+1 6077380470</span>
                </div>
                <div className="flex items-start">
