            ...
            <div className="space-y-12">
              <div>
                ...
                <div className="space-y-8">
                  {[
                    { icon: Phone, title: 'Voice Support', value: '+1 6077380470', desc: 'Available Mon-Fri, 9AM-6PM EST', color: 'text-orange-600', bg: 'bg-orange-50', border: 'border-orange-100' },
              ...
              <div className="p-10 rounded-[2.5rem] bg-slate-50 border border-slate-200 space-y-6 shadow-sm relative overflow-hidden">
                ...
                <div className="pt-4">
                  <p className="text-3xl md:text-4xl font-black text-slate-900 underline decoration-orange-600 underline-offset-8 italic tracking-tighter">+1 6077380470</p>
                </div>
              </div>
            </div>
          </div>
